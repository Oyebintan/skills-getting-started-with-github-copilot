...
activities = {
    ...
    "Art Studio": {
        ...
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "sophia.art@mergington.edu"]
    },
    "Drama Club": {
        "description": "Act in plays and musicals, develop stage performance skills",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["christopher@mergington.edu", "sarah@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and explore STEM concepts through hands-on projects",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["alex.science@mergington.edu", "rachel@mergington.edu"]
    }
}
...
def remove_participant(activity_name: str, email: str):
    ...
    remaining = len(activity["participants"])
    logger.info("Removed participant %s from %s, %d remaining", email, activity_name, remaining)
    return {
